...
async def feedback(_, message: Message) -> None:
    await message.reply_text(
        text="This project is Managed by ❤️",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "👨🏻‍🦯 Owner",
                        url="https://t.me/NobitaNobi_420",
                    ),
                    InlineKeyboardButton(
                        "❓ Bug Report",
                        url="https://t.me/Kratos_71",
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "🌪 Offical Channel",
                        url="https://t.me/nobitanobiproject",
                    )
                ],
            ]
        ),
        ...
        await message.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Support group", url="https://t.me/botsupportgr"
                        )
                    ]
                ]
            ),
